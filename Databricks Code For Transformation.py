...
storage_account_name = "olistdatastorageaccounts"
application_id = "25fe52a4-242f-4015-b10c-5a3bf765ca9c"      # Client ID
directory_id = "bf93bb5e-ecf0-4e3d-be0e-79b5cc527a48"       # Tenant ID
client_secret = "LeA8Q~E1SoLnbC5KdEgGrfb_RCDJMmDgLeS8qc1T"   # Client Secret

# Construct endpoint
endpoint = f"https://login.microsoftonline.com/{directory_id}/oauth2/token"

# ==============================
# Spark OAuth Configuration
# ==============================
...
customer_df = spark.read.format("csv").option("header", "true").load("abfss://olistdata@olistdatastorageaccounts.dfs.core.windows.net/bronze/olist_customers_dataset.csv")
display(customer_df)
...
hostname = "0kw9rc.h.filess.io"
database = "olistdataNosql_rulertell"
port = "27018"
username = "olistdataNosql_rulertell"
password = "5c182d5071a37735f7bcaac0356ef70e53256b64"
